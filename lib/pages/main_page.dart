...
import 'package:telemedicine_app/app/constant.dart';
import 'package:telemedicine_app/app/theme.dart';
import 'package:telemedicine_app/pages/home/home_page.dart';
...
class MainPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: selectedPage.value == 0 ? HomeScreen() : ProfilPage(),
    );
  }
}
